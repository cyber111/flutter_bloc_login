...
class AuthenticationBloc extends Bloc<AuthenticationEvent, AuthenticationState> {
  AuthenticationBloc({
    ...
    on<AuthenticationRequested>(_onSubscriptionRequested);
  ...
  Future<void> _onSubscriptionRequested(AuthenticationRequested event, Emitter<AuthenticationState> emit) {
    return emit.onEach(
